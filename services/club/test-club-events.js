...
// Test the US-006 endpoint functionality
console.log('Testing US-006: Filter/Search Events of Club');
...
try {
  ...
  const result1 = getClubEventsService('club-001', dto1);
...
try {
  ...
  const result2 = getClubEventsService('club-001', dto2);
...
try {
  ...
  const result3 = getClubEventsService('non-existent-club', dto3);
