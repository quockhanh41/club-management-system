    ...
    widgets = [
      ...
      # ==============================================================================
      {
        ...
        properties = {
          ...
          metrics = [
            ["AWS/ECS", "DesiredTaskCount", "ServiceName", module.auth_service.service_name, "ClusterName", aws_ecs_cluster.main.name, { stat = "Average", label = "Auth Desired" }],
      ...
      
      {
        ...
        properties = {
          ...
          region = var.aws_region
          metrics = [
            ["AWS/ECS", "CPUUtilization", "ServiceName", module.auth_service.service_name, "ClusterName", aws_ecs_cluster.main.name, { stat = "Average", label = "Auth CPU" }]
          ]
          view   = "timeSeries"
          stacked = false
          period = 300
      ...
      # ==============================================================================
      {
        ...
        properties = {
          ...
          region = var.aws_region
          metrics = [
            ["AWS/ECS", "MemoryUtilization", "ServiceName", module.auth_service.service_name, "ClusterName", aws_ecs_cluster.main.name, { stat = "Average", label = "Auth Memory" }]
          ]
          view   = "timeSeries"
          stacked = false
          period = 300
...

      {
        ...
        properties = {
          ...
          region = var.aws_region
          metrics = [
            ["AWS/ApplicationELB", "RequestCount", "LoadBalancer", module.alb.alb_arn_suffix, { stat = "Sum", label = "Requests" }]
          ]
          view   = "timeSeries"
          stacked = false
          period = 300
      ...
      # ==============================================================================
      {
        ...
        properties = {
          ...
          region = var.aws_region
          metrics = [
            ["AWS/ApplicationELB", "TargetResponseTime", "LoadBalancer", module.alb.alb_arn_suffix, { stat = "Average", label = "Avg Response Time" }],
            ["...", { stat = "p95", label = "p95" }],
            ["...", { stat = "p99", label = "p99" }]
          ]
          view   = "timeSeries"
...

      {
        ...
        properties = {
          ...
          region = var.aws_region
          metrics = [
            ["AWS/ApplicationELB", "HTTPCode_Target_2XX_Count", "LoadBalancer", module.alb.alb_arn_suffix, { stat = "Sum", label = "2xx Success" }],
...

      {
        ...
        properties = {
          ...
          region = var.aws_region
          metrics = [
            ["AWS/ApplicationELB", "HealthyHostCount", "TargetGroup", module.auth_service.target_group_arn_suffix, "LoadBalancer", module.alb.alb_arn_suffix, { stat = "Average", label = "Healthy" }],
      ...
      # ==============================================================================
      {
        ...
        properties = {
          ...
          region = var.aws_region
          metrics = [
            ["AWS/RDS", "CPUUtilization", "DBInstanceIdentifier", module.databases.rds_identifier, { stat = "Average", label = "CPU %" }],
...

      {
        ...
        properties = {
          ...
          region = var.aws_region
          metrics = [
            ["AWS/RDS", "DatabaseConnections", "DBInstanceIdentifier", module.databases.rds_identifier, { stat = "Average" }]
          ]
          view   = "timeSeries"
          stacked = false
          period = 300
...

      {
        ...
        properties = {
          ...
          region = var.aws_region
          metrics = [
            ["AWS/RDS", "FreeStorageSpace", "DBInstanceIdentifier", module.databases.rds_identifier, { stat = "Average", label = "Free Storage" }],
...
resource "aws_cloudwatch_metric_alarm" "rds_high_cpu" {
  ...
  dimensions = {
    DBInstanceIdentifier = module.databases.rds_identifier
  }
